...
valid_userid = ['00sab00','1234','zippy','zowie','joshua','dorothy w','rebecca','darcey','samantha','raeanne','kimmie','cassie','moore222']
@app.route('/')
def view():
...
def recommend_top5():
    ...
    if  user_name in valid_userid and request.method == 'POST':
            ...
            get_top5 = model.Top_Products(top20_products)
